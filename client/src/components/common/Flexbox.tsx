...
export interface FlexboxProps {
	...
	paddingBetween?: Size
	className?: string
	overflow?: Property.BlockOverflow
	/* Size */
...
const BaseFlexbox = (props: FlexboxProps): JSX.Element => {
	const {
		children,
		justify = '',
		align = 'start',
	...
	Object.keys(styleObject).forEach((key) => {
		// @ts-expect-error For each types key as string
...
export const Flexbox = styled(BaseFlexbox)`
	...
	> *:not(:last-child) {
		margin-bottom: ${({ direction, marginBetween }): string | undefined => direction === 'column' || !direction ? getSize(marginBetween) : undefined};
		margin-right: ${({ direction, marginBetween }): string | undefined => direction === 'row' ? getSize(marginBetween) : undefined};

		padding-bottom: ${({ direction, paddingBetween }): string | undefined => direction === 'column' || !direction ? getSize(paddingBetween) : undefined};
